...
exports.sales_conversation_utterance_chain = exports.stage_analyzer_chain = exports.loadSalesConversationChain = exports.loadStageAnalyzerChain = void 0;
...
function loadStageAnalyzerChain(llm, verbose = false) {
    ...
    return new chains_1.LLMChain({ llm, prompt, verbose });
}
exports.loadStageAnalyzerChain = loadStageAnalyzerChain;
...
exports.loadSalesConversationChain = loadSalesConversationChain;
const verbose = true;
exports.stage_analyzer_chain = loadStageAnalyzerChain(llm_1.llm, verbose);
exports.sales_conversation_utterance_chain = loadSalesConversationChain(llm_1.llm, verbose);
